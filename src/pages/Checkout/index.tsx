...
import barCode from '../../assets/images/icon-boleto.png'
import creditCard from '../../assets/images/icon-cartao.png'
...
const Checkout = () => {
  ...
  const [installments, setInstallmentes] = useState<InstallmentArray[]>([])
  ...
  useEffect(() => {
    const calculateInstallments = () => {
      const installmentsArray: InstallmentArray[] = []
      for (let i = 1; i <= 6; i++) {
    ...
    if (totalPrice > 0) {
      setInstallmentes(calculateInstallments())
    }
  }, [totalPrice])
                  ...
                  <>
                    ...
                    <S.Row marginTop="24px">
                      <S.InputGroup maxWidth="150px">
                        ...
                        >
                          {installments.map((i) => (
                            <option key={i.quantity} value={i.quantity}>
